...
The hex plot reveals that while most of the data points cluster tightly
along a line where tmax is greater than tmin, there are some unusual
cases where tmax is recorded as less than tmin. This is not physically
possible and raises important concerns regarding data quality.

The boxplot for snowfall between 0 and 100 mm shows fairly consistent
patterns across years, with the median snowfall amount remaining around
25 mm. This suggests that most snowfalls are relatively light or
moderate.

The boxplots display some variability and outliers, particularly in
years with snowfalls near the upper limit of the filter (close to 100
mm). These could represent unusually heavy snow events for those years.
...
![](p8105_hw3_tc3326_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](p8105_hw3_tc3326_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](p8105_hw3_tc3326_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
Comments:
...
![](p8105_hw3_tc3326_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
Comments:
...
![](p8105_hw3_tc3326_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
Comments:
